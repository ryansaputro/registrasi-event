      ...
      <div class="box panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title">Silahkan Pilih Menu  
              <a href="{{ route('marital.create') }}" class="btn btn-success btn-sm pull-right modal-show" style="margin-top: -6px;" title="Tambah Marital"><i class="icon-plus"></i> Tambah Marital</a>
          </h3>
        </div>
...
@push('scripts')
    ...
    <script type="text/javascript">
        var oTable = $('#datatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('table.marital') }}", //diambil dari routes/web
            columns: [
                {data: 'id_marital', name: 'id_marital'}, //data = nama field db
