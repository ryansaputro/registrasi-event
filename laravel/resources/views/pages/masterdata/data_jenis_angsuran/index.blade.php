      ...
      <div class="box panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title">Silahkan Pilih Menu  
              <a href="{{ route('jenis_angsuran.create') }}" class="btn btn-success btn-sm pull-right modal-show" style="margin-top: -6px;" title="Tambah Jenis Angsuran"><i class="icon-plus"></i> Tambah Jenis Angsuran</a>
          </h3>
        </div>
...
@push('scripts')
    ...
    <script type="text/javascript">
        var oTable = $('#datatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('table.jenis_angsuran') }}", //diambil dari routes/web
            columns: [
                {data: 'id_jenis_angsuran', name: 'id_jenis_angsuran'}, //data = nama field db
