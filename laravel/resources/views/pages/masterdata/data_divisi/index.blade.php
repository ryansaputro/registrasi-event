      ...
      <div class="box panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title">Silahkan Pilih Menu  
              <a href="{{ route('divisi.create') }}" class="btn btn-success btn-sm pull-right modal-show" style="margin-top: -6px;" title="Tambah Divisi"><i class="icon-plus"></i> Tambah Divisi</a>
          </h3>
        </div>
...
@push('scripts')
    ...
    <script type="text/javascript">
        var oTable = $('#datatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('table.divisi') }}", //diambil dari routes/web
            columns: [
                {data: 'id_divisi', name: 'id_divisi'}, //data = nama field db
