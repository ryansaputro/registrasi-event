...
<head>
	...
	<title>Data Pengajuan Pinjaman - Print</title>
	<!-- Bootstrap core CSS -->
...
<div class="container">
	<div class="row header_tab">
		...
		<table class="title" width="100%" style="margin-bottom:20px;">
			<tr>
				<td colspan="2" style="text-align:center;"><b>PENGAJUAN PINJAMAN</b></td>
			</tr>
		</table>	
	</div>
	<div>
