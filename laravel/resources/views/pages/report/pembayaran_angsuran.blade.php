...
<head>
	...
	<title>Data Pembayaran Angsuran - Print</title>
	<!-- Bootstrap core CSS -->
...
<div class="container">
	<div class="row header_tab">
		...
		<table class="title" width="100%" style="margin-bottom:20px;">
			<tr>
				<td colspan="2" style="text-align:center;"><b>PEMBAYARAN ANGSURAN</b></td>
			</tr>
		</table>	
	</div>
	<div>
		<table class="table table-bordered" width="100%">
			...
			<tbody>
				...
				<tr>
					<td class="text-center">{{ $value->no_angsuran }}</td>
                    ...
                    <td class="text-center">{{ $value->tgl_bayar }}</td>
				</tr>
				@endforeach
			</tbody>
		</table>
