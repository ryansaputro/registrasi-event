...
@endif
  ...
  @endphp
    ...
    <div class="container" style="padding-top:10px;">
        <form action="{{ route('event.registrasi', ["kode_event" => $kode_event, "id_peserta" => $id_peserta ]) }}" method="post" class="form-peserta" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="col-md-12">
                <div class="col-md-12">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group has-feedback">
                                ...
                                @foreach($model AS $k => $v)
                                    <br>
                                    <label class="radio-inline">
                                        <input type="radio" name="model" onclick="JersyChange(this)" value="{{$v->model}}">{{$v->model}}
                                    </label>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    <div class="col-md-12" style="border:1px solid whitesmoke;margin-bottom:10px;">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis minus iste veniam laborum quos repellat voluptatibus nulla dolore molestias laudantium quae reiciendis, illo ex delectus quam, debitis tenetur enim velit!
                    </div>
