<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image" style="background-image: url({{ asset('laravel/public/images/eo/logo/'.Session::get('data')['foto']) }});height: 45px;width: 45px;background-size: cover;background-repeat: no-repeat;border-radius: 50px;">
