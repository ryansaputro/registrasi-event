...
class RegistrasiEoModel extends Model //Model
{
    ...
    protected $fillable = [
       'id', 'id_member', 'kode', 'nama', 'kontak', 'no_hp_kontak', 'no_wa_kontak', 'id_provinsi', 'id_kota', 'alamat', 'kode_pos', 'alamat_web', 'logo', 'identitas', 'buku_rekening', 'no_rekening', 'pemilik_rekening', 'nama_bank', 'status', 'created_at', 'updated_at'
    ];
