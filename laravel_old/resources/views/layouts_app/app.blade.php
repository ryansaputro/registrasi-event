...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>SIKTIKA | Sistem Informasi Koperasi</title>
  ...
  <div class="wrapper">
    <header class="main-header">
        ...
        <a href="dashboard" class="logo">
          ...
          <h4 class="text-center"><b style="color:#da0b45;text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;">Event</b> <b style="color:#fff;text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;">Organizer</b></h4>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <div class="image" style="background-image: url({{ asset('storage/images/eo/'.Session::get('data')['foto']) }});height: 45px;width: 45px;background-size: cover;background-repeat: no-repeat;border-radius: 50px;position: absolute;margin-left: -50px;margin-top: -13px;">
                  </div>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <div class="image" style="background-image: url({{ asset('laravel/public/images/eo/'.Session::get('data')['foto']) }});height: 100px;background-size: cover;background-repeat: no-repeat;">
                    </div>
                    <p>
