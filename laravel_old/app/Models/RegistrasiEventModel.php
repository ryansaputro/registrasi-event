...
class RegistrasiEventModel extends Model //Model
{
    ...
    protected $fillable = [
       'id', 'kode_event', 'nama_event', 'tanggal_mulai', 'tanggal_akhir', 'tempat_event', 'id_provinsi', 'id_kota', 'id_kecamatan', 'id_desa', 'kode_pos', 'waktu_kumpul', 'tempat_kumpul', 'deskripsi_event', 'url_event', 'url_lain', 'created_at', 'updated_at', 'id_eo', 'id_jenis_event', 'sponsor', 'jumlah_peserta', 'e_poster'
    ];
