...
Route::group(['middleware' => ['usersession','web']], function(){
  ...
  Route::get('/{nama_eo}/registrasi_peserta/daftar_peserta/dataTable', 'DaftarPesertaController@dataTable')->name('daftar_peserta.index');
});

//registrasi peserta event
Route::get('/event/{nama_event}/{id_peserta}', 'RegistrasiPesertaEventController@index');
Route::post('/event/{nama_event}/{id_peserta}', 'RegistrasiPesertaEventController@registrasi')->name('event.registrasi');
